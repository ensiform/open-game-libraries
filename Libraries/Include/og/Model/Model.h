...
namespace og {
	...
	struct Vertex {
		...
		//! Constructor. 
		// ==============================================================================
		Vertex() : numWeights(0), weights(OG_NULL) {}
	...
	public:
		...
		//! Constructor. 
		// ==============================================================================
		Mesh() : flags(0), detailLevel(0), numVerts(0), numIndices(0), texCoords(OG_NULL), indices(OG_NULL) {}
	...
	public:
		...
		//! Constructor. 
		// ==============================================================================
		MeshStatic() : vertices(OG_NULL), normals(OG_NULL) {}
